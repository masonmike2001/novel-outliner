        ...
        <div className="container px-5">
          <div className="text-center mb-5">
            ...
            <p className="lead text-white-50">
              Choose your goals and story structure. Generate a complete chapter
              roadmap.
            </p>
          </div>
              ...
              <div className="card bg-dark border-secondary shadow-lg">
                <div className="card-body p-5">
                  <form id="appForm" onSubmit={handleSubmit}>
                    <h4 className="text-white mb-4">Project Details</h4>
                    ...
                    <h4 className="text-white mt-3 mb-3">Story Structure</h4>
                    ...
                    <div className="mt-4 p-4 bg-black rounded">
                      <h5 className="text-white">Outline Preview</h5>
